...
public class SubjectService {
    ...
    public SubjectResponseDTO getById(int id) {
    ...
    @Transactional
    public SubjectResponseDTO updateTitularBySubject(int subjectId, int titularId) {
    ...
    public List<SubjectResponseDTO> getSubjectByTitular(int titularId) {
