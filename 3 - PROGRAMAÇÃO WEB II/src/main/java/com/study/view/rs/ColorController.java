...
public class ColorController {
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<ColorDTO> getById(@PathVariable("id") final int id) {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<ColorDTO> update(@PathVariable("id") final int id, @RequestBody final ColorDTO color) {
