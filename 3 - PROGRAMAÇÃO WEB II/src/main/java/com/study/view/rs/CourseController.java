...
public class CourseController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CourseResponseDTO> getCourse(@PathVariable("id") Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CourseResponseDTO> updateCourse(@PathVariable("id") Integer id, @RequestBody @Valid CourseRequestDTO course) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> removeCourse(@PathVariable("id") Integer id) {
        service.delete(id);
