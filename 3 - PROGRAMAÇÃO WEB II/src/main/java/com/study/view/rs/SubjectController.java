...
public class SubjectController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SubjectResponseDTO> getSubject(@PathVariable("id") int id) {
    ...
    public ResponseEntity<SubjectResponseDTO> updateTitularBySubject(@PathVariable("subjectId") int subjectId, @PathVariable("teacherId") int teacherId) {
